 ...
 */
public class parseInspect {
    public static ArrayList<ClientAssetInspect> getList(String JSONString) throws JSONException {
        ArrayList<ClientAssetInspect> arr = new ArrayList<ClientAssetInspect>();
        ...
        for (int i = 0; i < jArray.length(); i++) {
            try {
                ...
                String is_present = (obj.getString("is_present").equals("null") ? "" : obj.getString("is_present"));
