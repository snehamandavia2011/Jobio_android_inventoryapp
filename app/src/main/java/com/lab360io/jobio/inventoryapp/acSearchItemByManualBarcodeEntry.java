...
public class acSearchItemByManualBarcodeEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBindingUtil.setContentView(this, R.layout.search_item_by_manual_barcode_entry);
        ac = this;
        mContext = this;
        objHelper.setActionBar(ac, mContext.getString(R.string.strSearchItem));
    }
