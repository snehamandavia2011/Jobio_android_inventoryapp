 ...
 */
public class frOnBoardingScreen3 extends Fragment implements WelcomePage.OnChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // txtTitle.setText(R.string.strDoSmartly);
        //txtDesc.setText(R.string.msgDoSmartly);
        //img.setImageResource(R.drawable.ic_on_boarding_do_smartly1);
        return v;
    }
