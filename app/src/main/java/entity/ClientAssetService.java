        ...
        if (cur != null && cur.getCount() > 0) {
            ...
            do {
                ...
                arrClientAsset.add(new ClientAssetService(cur.getString(1), cur.getString(2), cur.getString(3), cur.getString(4), cur.getString(5), cur.getString(6),
                        ...
                        cur.getString(40), cur.getString(41), cur.getString(42), cur.getString(43), viewStatus, new Helper().getFormFromDatabase(cur.getString(1), "S", mContext)));
