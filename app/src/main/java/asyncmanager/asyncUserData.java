...
public class asyncUserData extends Thread {
    ...
    public void getData() {
        ...
        ServerResponse objServerResponse = objHttpEngine.getDataFromWebAPI(ctx, um.getUrl(), new String[]{userName, password, qrcode, String.valueOf(tokenId), account_id,"S"}, um.getParamNames(), um.isNeedToSync());
